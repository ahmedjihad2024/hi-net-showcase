...
class GetCheckoutDetailsUseCase extends Base<String, CheckoutResponse> {
  final RepositoryAbs _repository;

  GetCheckoutDetailsUseCase(this._repository);

  @override
  Future<Either<Failure, CheckoutResponse>> execute(String packageId) async {
    return await _repository.getCheckoutDetails(packageId);
  }
}
