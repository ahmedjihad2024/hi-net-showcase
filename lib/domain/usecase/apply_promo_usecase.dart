...
class ApplyPromoUseCase extends Base<ApplyPromoRequest, ApplyPromoResponse> {
  final RepositoryAbs _repository;

  ApplyPromoUseCase(this._repository);

  @override
  Future<Either<Failure, ApplyPromoResponse>> execute(
    ApplyPromoRequest input,
  ) async {
    return await _repository.applyPromo(input);
  }
}
