...
class GetMinVersionUseCase extends Base<NoParams, MinVersionResponse> {
  final RepositoryAbs _repository;

  GetMinVersionUseCase(this._repository);

  @override
  Future<Either<Failure, MinVersionResponse>> execute(NoParams input) async {
    return await _repository.getMinVersion();
  }
}
