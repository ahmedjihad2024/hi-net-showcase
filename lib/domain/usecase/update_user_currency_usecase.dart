...
class UpdateUserCurrencyUseCase
    extends Base<UpdateUserCurrencyRequest, GetUserResponse> {
  final RepositoryAbs _repository;

  UpdateUserCurrencyUseCase(this._repository);

  @override
  Future<Either<Failure, GetUserResponse>> execute(
    UpdateUserCurrencyRequest input,
  ) async {
    return await _repository.updateUserCurrency(input);
  }
}
